...
export interface Story {
  ...
  /**
   * Below the Radar (Project Bible §3.3): true if this story hit the detection
   * threshold (3+ sources) but did not reach the publication threshold
   * (5+ sources across 2+ editorial perspectives) within 24 hours, AND has at
   * least one Tier 1 (AP or Reuters) source. BTR stories render in a separate
   * home-feed section and always carry a yellow (Developing) badge.
   */
  belowTheRadar?: boolean;
  readingLevels: {
    young: ReadingLevel;
    teen: ReadingLevel;
    adult: ReadingLevel;
  ...
  },
  {
    ...
    sources: {
      confirming: [
        ...
        {
          name: "Ballotpedia",
          type: "Elections Reference / Primary Source",
    ...
    sources: {
      confirming: [
        ...
        },
        {
          ...
          type: "Policy Research / Primary Source",
          location: { country: "US", usState: "DC" },
        },
        {
          name: "Fox News",
    ...
    sources: {
      confirming: [
        ...
        },
        {
          ...
          type: "Science Advocacy / Primary Source",
          location: { country: "US", usState: "CA" },
        },
        {
          name: "SpaceNews",
